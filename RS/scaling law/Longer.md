...
### 3.4 Token Merge
原始transformer的二次注意力计算复杂度为$O(L^2d)$，其中L为序列长度，d为embedding维度，本文使用Token Merge策略避免丢失chang
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODAzODgyNDEsNTc1Nzc1ODAzLDEwNz
k0MjEyNzEsLTE2MjY2MjE2NTUsOTMxMTgzMzY1LDEyODYyMzgz
NzksLTkxOTc4MTAyOF19
-->