...
#### 代码实现
```Python
share_output=[expert(task_fea[-1]).unsqueeze(1) for expert in self.share_experts[i]] # share_experts为layers_num个m
```
### 4.3 Gate加权输出
#### 代码实现
```Python
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwMzY5NDI3OCwxOTE4ODg5NzgzLDIxMz
I0OTU5NjcsNjEzODQyMTkxLC0xNzU0MTE2NzIzLDE3OTU3NTAy
MzAsMjA4MDU2MTYzNF19
-->