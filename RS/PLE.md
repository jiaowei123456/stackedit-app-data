...
#### 代码实现
```Python
share_output=[expert(task_fea[-1]).unsqueeze(1) for expert in self.share_experts[i]] # share_experts为layers_num个
```
### 4.3 Gate加权输出
#### 代码实现
```Python
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjQ3MDYxMDksMTkxODg4OTc4MywyMT
